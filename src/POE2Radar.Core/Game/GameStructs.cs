...
/// <summary>Sockets + links on an item. Size = 0x60.</summary>
[StructLayout(LayoutKind.Explicit, Size = 0x60)]
public struct SocketsComponent
{
    [FieldOffset(0x28)] public StdVector Sockets;       // SocketColorList
    [FieldOffset(0x40)] public StdVector LinkSizes;
    [FieldOffset(0x60)] public StdVector SocketedGems;   // SocketedGemList
}
...
public struct ModsComponent
{
    ...
    [FieldOffset(0x180)] public NativePtrArray ItemMods;        // combined list — filter by mod type for impl/expl
...
{
    [FieldOffset(0x10)] public long SkillGemInternalPtr;
    [FieldOffset(0x18)] public uint TotalExpGained;
    [FieldOffset(0x1C)] public uint Level;
    [FieldOffset(0x20)] public uint ExperiencePrevLevel;
    [FieldOffset(0x24)] public uint ExperienceMaxLevel;
}
